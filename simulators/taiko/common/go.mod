...
//replace github.com/marioevz/eth-clients => github.com/taikoxyz/hive-taiko-clients v0.0.0-20240124161112-88749a6e8367
...
require (
	...
	//github.com/marioevz/mock-builder v0.0.0-20230515180219-3b0b5c3eefe3
